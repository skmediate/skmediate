...
Shows the different combinations of parameters used to simulate null and true data.
...
outcomes, exposures, mediators, true_alpha, true_beta, true_gam = make_mediation(n_informative_mo=20)
print(true_alpha)
print(np.round(np.transpose(true_beta),1))
print(np.round(np.transpose(true_gam)),1)
